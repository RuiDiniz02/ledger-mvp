...
const en = {
  ...
  saving: 'Savings', balance: 'balance', thisMonthShort: 'this month',
  committed: 'Committed this month', potBalanceLabel: 'In the pot',
  kindVariableHelp: 'Counts only what you log. Warns at 80%.',
  kindFixedHelp: 'Leaves your budget every month whether you log it or not.',
  kindSavingHelp: 'Builds up month after month. Log an expense to take money out.',
...
const pt: typeof en = {
  ...
  saving: 'Poupança', balance: 'saldo', thisMonthShort: 'este mês',
  committed: 'Comprometido este mês', potBalanceLabel: 'No pote',
  kindVariableHelp: 'Conta só o que registares. Avisa aos 80%.',
  kindFixedHelp: 'Sai do orçamento todos os meses, registes ou não.',
  kindSavingHelp: 'Acumula mês após mês. Regista uma despesa para tirar do pote.',
