...
const en = {
  ...
  poolFromFreed: '{amount} freed by a full pot', poolBoth: '{carry} from {month} · {freed} freed',
  distribute: 'Hand out', stillToPlace: 'still to place', giveAll: 'tap a figure to give it everything',
  monthBudgetRow: 'The month in general', doneDistributing: 'Done', extraGiven: '{amount} handed out',
...
const pt: typeof en = {
  ...
  poolFromFreed: '{amount} libertos por um pote cheio', poolBoth: '{carry} de {month} · {freed} libertos',
  distribute: 'Distribuir', stillToPlace: 'ainda por atribuir', giveAll: 'toca num valor para dar tudo',
  monthBudgetRow: 'O mês em geral', doneDistributing: 'Concluir', extraGiven: '{amount} distribuídos',
