...
const en = {
  ...
  committed: 'Committed this month', potBalanceLabel: 'In the pot',
  kindVariableHelp: 'Spending that changes. Warns at 80% of the target.',
  kindFixedHelp: 'The same bill every month. Fills up without a warning at 80%.',
...
const pt: typeof en = {
  ...
  committed: 'Comprometido este mês', potBalanceLabel: 'No pote',
  kindVariableHelp: 'Gastos que variam. Avisa aos 80% do limite.',
  kindFixedHelp: 'A mesma conta todos os meses. Enche sem avisar aos 80%.',
